...
suite('homepage examples', function() {
  suite('human-readable output', function() {
    ...
    [
      ...
      { cron: '15,45 9,21 * * *', readable: '9:15 AM, 9:45 AM, 9:15 PM and 9:45 PM every day' },
      { cron: '18,19 7 5 * *', readable: '7:18 AM and 7:19 AM on the 5th of every month' },
      ...
      { cron: '0 17 * 1,4,7,10 *', readable: '5:00 PM every day in Jan, Apr, Jul and Oct' },
      ...
      { cron: '0 2,16 1,8,15,22 * 1,2', readable: '2:00 AM and 4:00 PM on the 1, 8, 15 and 22nd of every month and every Mon and Tue' },
      ...
      { cron: '0 0 18 1/1 * ?', readable: '12:00 AM on the 18th day of every month' },
      { cron: '0 0 18 1/1 * ? *', readable: '6:00 PM', sixth: true },
      { cron: '30 10 * * 0', readable: '10:30 AM on Sun' }
